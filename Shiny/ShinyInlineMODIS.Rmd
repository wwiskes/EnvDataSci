...
It's also possible to embed an entire Shiny application as inline an R Markdown document. The following code can also 
be used to create a Shiny web app by saving it as `app.r` in an RStudio Shiny app project:
