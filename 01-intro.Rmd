...
instead looks like `(NIR-R)/(NIR+R)`.  Similarly `*` must be used to multiply; there's no assumed multiplication 
...
except for the fact that it wouldn't make sense to R. We'll need to talk about expressions and statements.
