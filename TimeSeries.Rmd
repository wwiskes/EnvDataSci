...
flux towers [@blackburn2021carbon]

```{r fig.align = 'left', out.width = "75%", fig.cap = "Red Clover Valley eddy covariance flux tower", echo=F}
knitr::include_graphics(here::here("img", "RCVfluxTower2.png"))
```
```{r fig.align = 'left', out.width = "75%", fig.cap = "Loney Meadow eddy covariance flux results", echo=F}
