...
Purpose is to compare group. Can be thought of as an extension of a t test where you have more than two groups, or as a linear model where one variable is a factor.
...
- Analyses can be visual – looking at a map
