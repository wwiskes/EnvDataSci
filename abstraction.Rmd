...
<img src="img/Tukey1977.png" width="161" height="230" style="horizontal-align:right">He followed this up in 1977 with *Exploratory Data Analysis*. 
...
A simple statistical summary is very easy to do, and we'll use **`eucoak`** data in the `iGIScData` from a study of comparative runoff and erosion under Eucalyptus and oak canopies [@eucoak]:
