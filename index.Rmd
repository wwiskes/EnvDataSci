...
<img src="logoIGIScSFSU150.png" align="right">

We've also created a repository on GitHub that includes data we've developed in the iGISc at SFSU, and youu'll need to install that package a slightly different way. GitHub packages require a bit more work on 
